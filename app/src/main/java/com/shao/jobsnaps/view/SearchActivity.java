...
import com.shao.jobsnaps.presenter.SearchPresenter;
...
public class SearchActivity extends BaseActivity implements ICategoryView,View.OnClickListener,
    ...
    private TextView searchTextEt;
    private TextView doSearchTv;
    private ImageView crearTextIv;
    ...
    public void setSearchView()
    {
        ...
        searchTextEt.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                searchPresenter.searchFiles(keyWords);
            }
    ...
    protected void initEvent() {
        ...
        doSearchTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        crearTextIv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    protected void initView() {
        barBack = (ImageView) findViewById(R.id.search_back);

        searchTextEt  = (TextView) findViewById(R.id.search_et);

        doSearchTv = (TextView) findViewById(R.id.search_do);

        crearTextIv = (ImageView) findViewById(R.id.search_clear_iv);

        mListView = (SlideAndDragListView) findViewById(R.id.search_file_list);
    }
    ...
    private void scanImgFile(int position, Long pId) {
        Intent intent = new Intent(SearchActivity.this,CatImagPagerActivity.class) ;
...
/*            for(FilesCustom filesCustom : fileCustoms)
 ...
 /*       if (itemSel.getFType().equals(IFileType.FILE_TYPE_FLODER)) {
    ...
    public void addDataToView(final List<FilesCustom> fileCustoms,List<Files> files) {
        ...
        mAdapter = new CommAdapter<FilesCustom>(SearchActivity.this, fileCustoms, R.layout.item_file_list2) {
            @Override
            public void convert(ViewHolder holder, final FilesCustom item) {
                ...
                holder.setImageResourceFromCache(R.id.item_file_img,item.getFile(),SearchActivity.this, OpenFile.setItemIcon(item.getFile()));
/*                TextView fromTv = (TextView) holder.getConvertView().findViewById(R.id.item_file_tv_from);
                ...
                holder.setClick(R.id.item_file_tv_from, new CallBackListener() {
                    ...
                    public void OnSuccess() {
                        Intent it = new Intent(SearchActivity.this,FileActivity.class) ;
                        it.putExtra("PROJECT_ID",(long)item.getFile().getProId()) ;
                        it.putExtra("PARENT_ID",item.getFile().getFFather()) ;
                        startActivity(it);
                    }
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        if (isSlectedMode) {
            ...
            if (fType.equals(IFileType.FILE_TYPE_FLODER)) {
                ...
                Intent it = new Intent(SearchActivity.this,FileActivity.class) ;
                it.putExtra("PROJECT_ID",(long)files.get(i).getProId()) ;
                it.putExtra("PARENT_ID",(long)files.get(i).getFId()) ;
                startActivity(it);
